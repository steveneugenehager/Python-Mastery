...
#
# 2025-11-12 Created. To Do:  How should None be handled?  This occurs when the argument is invalid.
#
...
def main():
    ...
    # test invalid data.
    numbers = [ 0 , 9 , 3.14 , 3e20, -7 , 3+7j , 'cat' ]
    for n in numbers:
...
def square(n):
    ...
    try:
        ...
        print("ERROR|Invalid data type.  Numbers only.")
